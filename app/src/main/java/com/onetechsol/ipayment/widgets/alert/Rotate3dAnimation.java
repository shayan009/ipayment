package com.onetechsol.ipayment.widgets.alert;
...
public class Rotate3dAnimation extends Animation {
    ...
    public Rotate3dAnimation(Context context, AttributeSet attrs) {
        ...
        Description d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_pivotX1));
        mPivotXType = d.type;
        mPivotXValue = d.value;

        d = parseValue(a.peekValue(R.styleable.Rotate3dAnimation_pivotY1));
        mPivotYType = d.type;

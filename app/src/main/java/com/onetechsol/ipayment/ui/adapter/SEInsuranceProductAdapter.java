...
import com.onetechsol.ipayment.databinding.SeInsuranceItemBinding;
import com.onetechsol.ipayment.pojo.InsuranceProduct;
import com.onetechsol.ipayment.pojo.ProductModel;

import java.util.List;

public class SEInsuranceProductAdapter extends RecyclerView.Adapter<SEInsuranceProductAdapter.ProductViewHolder> {
    ...
    public ProductViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        SeInsuranceItemBinding insuranceProductItemBinding = DataBindingUtil.inflate(LayoutInflater.from(parent.getContext()), R.layout.se_insurance_item, parent, false);
    ...
    public static class ProductViewHolder extends RecyclerView.ViewHolder implements ProductItemClickListener {
        ...
        private SeInsuranceItemBinding insuranceProductItemBinding;

        public ProductViewHolder(SeInsuranceItemBinding insuranceProductItemBinding) {

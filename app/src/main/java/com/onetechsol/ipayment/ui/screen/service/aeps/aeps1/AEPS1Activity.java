...
public class AEPS1Activity extends BaseActivity<AEPSViewModel, ActivityAeps1Binding> implements AEPS1TaskAdapter.AdapterCallback, AEPS1ClickListener {
    ...
    private void startService33Onboarding() {
        ...
        onShowLoading();
        mDisposable.add(viewModel().startServiceOnboarding("33").subscribe(
                onboardingCheckResponse ->
                {
                    ...
                    if (onboardingCheckResponse.status().equals("1")) {
                        ...
                        showAlertDialog("AEPS1 Details", onboardingCheckResponse.message(), true)
                    ...
                    showAlertDialog("AEPS1 Error", throwable.getMessage(), true)
                            .setPositiveButton("OK", (dialogInterface, i) -> {
    ...
    private void getBankItems() {
        ...
        onShowLoading();
        mDisposable.add(viewModel().getAeps1Features().subscribe(aeps1TaskModels -> {
            ...
            viewBinding().setAeps1TaskAdapter(aeps1TaskAdapter);

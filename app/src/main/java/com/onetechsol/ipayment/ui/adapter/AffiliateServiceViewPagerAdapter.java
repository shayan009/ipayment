...
public class AffiliateServiceViewPagerAdapter extends FragmentStateAdapter {


    private ArrayList<ServiceModel> serviceModelArrayList;

    public AffiliateServiceViewPagerAdapter(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
    ...
    public AffiliateServiceViewPagerAdapter setServiceModelArrayList(ArrayList<ServiceModel> serviceModelArrayList) {

...
public class ShimmerViewHolder extends RecyclerView.ViewHolder {
    ...
    public ShimmerViewHolder(LayoutInflater inflater, ViewGroup parent, int innerViewResId,int viewHolderShimmer) {
        super(inflater.inflate(viewHolderShimmer, parent, false));
        mShimmerLayout = (ShimmerLayout) itemView;;
        ViewGroup.LayoutParams layoutParams = parent.getLayoutParams();
        layoutParams.height = ViewGroup.LayoutParams.WRAP_CONTENT;
        layoutParams.width = ViewGroup.LayoutParams.MATCH_PARENT;
        mShimmerLayout.setLayoutParams(layoutParams);

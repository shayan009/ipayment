...
public class ShimmerAdapter extends RecyclerView.Adapter<ShimmerViewHolder> {
    ...
    public ShimmerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        ShimmerViewHolder shimmerViewHolder = new ShimmerViewHolder(inflater, parent,mLayoutReference,mShimmerReference);
    ...
    public void setmShimmerReference(int mShimmerReference) {

...
import com.shimmer.library.R;

public class ShimmerRecyclerView extends RecyclerView {

    private int mShimmerReference;
        ...
        try {
            ...
            switch (value) {
                case 0:
                    ...
                    setShimmerLayoutReference(R.layout.viewholder_shimmer);
                    break;
                case 1:
                    setDemoLayoutManager(LayoutMangerType.LINEAR_HORIZONTAL);
                    setShimmerLayoutReference(R.layout.viewholder_shimmer_horizonatal);
                    break;
                case 2:
            ...
            mShimmerAngle = a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_demo_angle, 10);
            ...
            mShimmerDuration = a.getInteger(R.styleable.ShimmerRecyclerView_shimmer_demo_duration, 1400);
    ...
    public int getShimmerReference() {
        return mShimmerReference;
    }
    /**
    ...
    public void setShimmerLayoutReference(int mShimmerReference) {
        this.mShimmerReference = mShimmerReference;
        mShimmerAdapter.setmShimmerReference(getShimmerReference());
    }
